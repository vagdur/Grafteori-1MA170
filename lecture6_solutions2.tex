...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{graphics/Exercise3/distinctWeights.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{graphics/Exercise3/distinctWeights2.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{graphics/Exercise3/distinctWeights3.png}
